...
;Modified by Nico Bendlin <nicode@gmx.net>
;Added MUI_WELCOMEPAGE_LINK feature (search for [NicoDE])
...
!macro MUI_FUNCTION_WELCOMEPAGE PRE LEAVE
  ...
  Function "${PRE}"
    ...
    !ifdef MUI_WELCOMEPAGE_LINK
      ...
      !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "Text" "${MUI_WELCOMEPAGE_LINK}"
      ...
      !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 4" "State" "${MUI_WELCOMEPAGE_LINK_LOCATION}"
    ...
    !ifdef MUI_WELCOMEPAGE_LINK
      ...
      SetCtlColors $MUI_TEMP1 "${MUI_WELCOMEPAGE_LINK_COLOR}" "${MUI_BGCOLOR}"
    !endif
