...
class Robot(NXTBrick):
    ...
    def __init__(self, wboot = True):
        ...
        self.console = ConsoleDialog(init_code='from api import *', 
                        init_text="            _  ___________ _____              _                                    _           _ \n" +
                                  "           | ||_   _|  _  \  ___|            | |                                  | |         | |\n" +
                                  " _ __ __  _| |_ | | | | | | |__    _ __ __  _| |_ ___ _ __ ___  _   _   _ __ __  _| |_ ___  __| |\n" +
                                  "| '_ \\ \/ / __|| | | | | |  __|  | '_ \\ \/ / __/ _ \ '_ ` _ \| | | | | '_ \\ \/ / __/ _ \/ _` |\n" +
                                  "| | | |>  <| |__| |_| |/ /| |___  | | | |>  <| ||  __/ | | | | | |_| | | | | |>  <| ||  __/ (_| |\n" +
                                  "|_| |_/_/\_\\__\___/|___/ \____/  |_| |_/_/\_\\__\___|_| |_| |_|\__,_| |_| |_/_/\_\\__\___|\__,_|\n" + 
